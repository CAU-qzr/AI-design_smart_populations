# -*- coding: utf-8 -*-
"""
Created on Thu Dec 25 16:58:46 2025
...
models = {
    ...
    "MLP": MLPRegressor(max_iter=1000, random_state=random_seed),
...
metrics = {name: {"Fold": [], "MAE": [], "RMSE": [], "R2": []} for name in models.keys()}
...
results_df.to_excel('Code-upload/AInm_method_results.xlsx')
